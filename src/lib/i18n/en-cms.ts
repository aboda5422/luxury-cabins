...
export const enCmsOverlay: DeepPartial<CmsData> = {
  ...
  sampleClients: [
    { name: "Saudi Aramco", sector: "Oil & Energy" },
    { name: "Qiddiya", sector: "Entertainment" },
    { name: "Ministry of Transport and Logistic Services", sector: "Government" },
    { name: "Ministry of Sport", sector: "Government" },
    ...
    { name: "Dirab Golf & Country Club", sector: "Leisure" },
    { name: "Dhahran Expo", sector: "Exhibitions" },
    { name: "Riyadh Front", sector: "Exhibitions" },
    { name: "Saudi Arabian Equestrian Federation", sector: "Sports" },
    { name: "Prince Majed Park", sector: "Leisure" },
    { name: "Ajwaa Alsaudia", sector: "Events" },
    { name: "The Gathering", sector: "Events" },
    { name: "CODE", sector: "Technology" },
    { name: "Hwadi", sector: "Events" },
    { name: "Event CleVer", sector: "Events" },
    { name: "WAVE EVENT", sector: "Events" },
    { name: "MACC Modern Arch", sector: "Design" },
    { name: "Blink Experience", sector: "Events" },
  ],
  faqs: [
    {
