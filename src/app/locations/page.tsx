...
import { SEO_CITIES, cityPath, cityTitleAr } from "@/lib/seo/cities";
import { breadcrumbSchema } from "@/lib/seo/schema";
import { siteConfig } from "@/lib/site";

export const metadata: Metadata = {
  title: "خدماتنا في مدن المملكة",
  description: `تأجير وبيع وتصنيع الكبائن والوحدات المتنقلة في الرياض وجدة ومكة والمدينة والدمام والخبر والجبيل ومدن المملكة مع ${siteConfig.nameAr}.`,
...
export default function LocationsIndexPage() {
  const primary = SEO_CITIES.filter((c) => c.priority === "primary");
  const secondary = SEO_CITIES.filter((c) => c.priority === "secondary");
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {primary.map((city) => (
              ...
              >
                ...
                <p className="mt-1 text-sm text-[#777]">{city.nameEn} — {city.regionAr}</p>
